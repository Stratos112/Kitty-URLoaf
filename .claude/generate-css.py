...
css = "\n".join([
    ...
    f"}}",
    f"/* #taskbar-tabs-favicon is an invisible html:img (no src), first child of #nav-bar.",
    f"   Stretched to cover the full nav-bar — clicks in the empty cat-body area land here",
    f"   and propagate :active up to #nav-bar, triggering the ear flick. */",
