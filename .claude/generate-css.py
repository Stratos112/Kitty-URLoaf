...
POS      = "left 182px top 0px"            # pseudo-element background (HEAD, EAR)
...
def rest_keyframes():
    ...
    cush_appear = f"background-image: {url(CUSH_APPEAR_PATH)}; background-position: left 182px top var(--cat-y);"
    show        = f"background-image: {rest_imgs}; background-position: left 182px top var(--cat-y);"
